  ...
  return (
    <div style={{minHeight:'100vh',background:'#F4F6FB',fontFamily:"'Plus Jakarta Sans',sans-serif"}}>
      ...
      <style>{`
        ...
        .scard{background:white;border-radius:16px;border:1px solid #D8E2F0;padding:22px;transition:all 0.3s ease;position:relative;overflow:hidden;cursor:default}
        ...
        .qacard{background:white;border-radius:16px;border:1px solid #D8E2F0;padding:20px;transition:all 0.3s cubic-bezier(.34,1.56,.64,1);text-decoration:none;display:block;position:relative;overflow:hidden}
      ...
      <div style={{maxWidth:1200,margin:'0 auto',padding:'36px 28px'}}>
        {/* Header */}
        <div className="au d1" style={{background:'linear-gradient(135deg,#0F1C35,#1B3A6B)',borderRadius:20,padding:'28px 32px',marginBottom:28,position:'relative',overflow:'hidden'}}>
          ...
          <div style={{display:'flex',alignItems:'center',gap:14,position:'relative',zIndex:1}}>
            ...
            <div>
              <h1 style={{fontFamily:'Fraunces,serif',fontSize:26,fontWeight:800,color:'white',marginBottom:3}}>Admin Dashboard</h1>
              <p style={{fontSize:13,color:'rgba(255,255,255,0.6)'}}>System overview and platform management</p>
            </div>
          </div>
        ...
        {loading ? (
          ...
          {/* Success Rate */}
          <div className="au d2" style={{background:'white',borderRadius:18,border:'1px solid #D8E2F0',padding:24,marginBottom:28}}>
            <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:14}}>
              ...
              <div style={{fontFamily:'Fraunces,serif',fontSize:40,fontWeight:800,background:'linear-gradient(135deg,#1B3A6B,#D4A017)',WebkitBackgroundClip:'text',WebkitTextFillColor:'transparent'}}>{rate}%</div>
            </div>
